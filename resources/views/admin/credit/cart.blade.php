...
@section('content')
	<div class="container">
			...
			<h2 class="text-center mt-5">Elige el tipo de Anuncio</h2>
		...
		<div class="row" id="lista-anuncios">
			<div class="col-12 col-xl-8">
				...
				<div class="col-xl-4">
					...
					<a href="{{ route('order.create') }}" class="btn btn-primary my-5">Confirmar Datos de la Orden de Compra</a>
					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<div class="card-footer py-4">
								<button type="button" class="btn btn-danger btn-block waves-effect waves-light ">Cancelar Compra</button>
							</div>	
					</div>
