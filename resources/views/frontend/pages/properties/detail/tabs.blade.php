            ...
            <div class="card text-center my-5" style="width: 100%;">
              <div class="card-header">
                <ul class="nav nav-tabs d-flex justify-content-around" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="caracter-tab" data-toggle="tab" href="#caracter" role="tab" aria-controls="caracter" aria-selected="false"><i class="far fa-address-card mr-2"></i>Descripción</a>
                  </li>
              ...
              <div class="card-body">
                <div class="tab-content" id="myTabContent">
                  ...
                  <div class="tab-pane fade show active overflow-auto" style="height:460px;" id="caracter" role="tabpanel" aria-labelledby="caracter-tab">
                      <!-- Description -->
                      <h3 class="text-left text-muted">Descripción</h3>
                        <p class="text-left text-muted">
                          {{ $property->detalle }}.
                        </p>

                      <!-- Details -->
                      <h3 class="text-left text-muted">Detalles</h3>
                      <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <h6 class="text-left">
                              <span class="text-dark-50">En :</span>
                            ...
                            <h6 class="text-left">
                              <span class="text-dark-50">Lista para estrenar. </span>
                            </h6>
                            @endif
                            @if( $property->en_amoblado )
                            <h6 class="text-left">
                              <span class="text-dark-50">Inmueble amoblado. </span>
                            </h6>
                            @endif
                            @if( $property->en_parque )
                            <h6 class="text-left">
                              <span class="text-dark-50">Ubicado frente a un parque. </span>
                            </h6>
                            @endif
                            @if( $property->en_esquina )
                            <h6 class="text-left">
                              <span class="text-dark-50">Ubicado en esquina. </span>
                            </h6>
                            @endif
                            @if( $property->en_avenida )
                            <h6 class="text-left">
                              <span class="text-dark-50">Ubicado en avenida principal. </span>
                            </h6>
                            @endif
                            @if( $property->en_condominio )
                            <h6 class="text-left">
                              <span class="text-dark-50">Inmueble dentro de condominio. </span>
                            </h6>
                            @endif
                             @if( $property->en_provivienda )
                            <h6 class="text-left">
                              <span class="text-dark-50">Ofrecido en programa pro vivienda. </span>
                            </h6>
                            @endif
                        ...
                        <div class="col-12 col-md-6">
                            <h6 class="text-left">
                              ...
                              <span class="h3 text-muted ml-2">{{ $property->precio }}.00</span>
                            </h6>
                      ...
                      <!-- Caracteristicas -->
                      <h3 class="text-left text-muted">Caracteristicas</h3>
                   ...
                   <div class="tab-pane fade" style="height:460px;" id="plano" role="tabpanel" aria-labelledby="plano-tab">
                    ...
                    <div class="accordion" id="accordionPlanos">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionPlanos">
                          <div class="card-body">
                            ...
                            <div class="text-truncate">
                              ...
                              <p>Vista detallando el segundo piso.</p>
                            </div>
                      ...
                      <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionPlanos">
                          <div class="card-body">
                            <div class="text-truncate">
                              <a href="https://i.imgur.com/0zJYERy.jpg">
                                <img src="https://i.imgur.com/0zJYERy.jpg" class="img-fluid" alt="" width="500" height="300">
                              </a>
                            </div>
                          </div>
                        </div>
